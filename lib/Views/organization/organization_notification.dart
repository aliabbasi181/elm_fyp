...
class _OrganizationNotificationState extends State<OrganizationNotification> {
  ...
  initState() {
    super.initState();
    data.add(Notification("Abu-bakar is out of fence", "12/01/2022", "02:05"));
    data.add(Notification("Ali is out of fence", "12/01/2022", "02:10"));
    data.add(Notification("Abu-bakar is out of fence", "12/01/2022", "02:15"));
    data.add(
        Notification("Sharjeel Dar is out of fence", "12/01/2022", "02:20"));
