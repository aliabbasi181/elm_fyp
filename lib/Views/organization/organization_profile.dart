...
class _OrganizationProfileState extends State<OrganizationProfile> {
  @override
  void initState() {
    print(Constants.organization.email);
    super.initState();
  }
                              ...
                              DottedBorder(
                                  ...
                                  child: Column(
                                    children: [
                                      UserDetailRow(
                                        heading: "Phone",
                                        body: Constants.organization.phone
                                            .toString(),
                                      ),
                                      UserDetailRow(
                                        heading: "Address",
                                        body: Constants.organization.address
                                            .toString(),
                                      ),
                                      UserDetailRow(
                                        heading: "Role",
                                        body: Constants.organization.role
                                            .toString(),
                                      ),
                                      UserDetailRow(
